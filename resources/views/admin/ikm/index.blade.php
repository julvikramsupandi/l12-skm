<x-layout.admin.app title="Indeks Kepuasan Masyarakat (Provinsi Gorontalo)">

    @push('css')
        <link rel="stylesheet" href="{{ asset('assets/admin/css/plugins/style.css') }}" />
    @endpush

    <x-layout.admin.pageheader title="Indeks Kepuasan Masyarakat (Provinsi Gorontalo)" :breadcrumb="[['label' => 'Indeks Kepuasan Masyarakat (Provinsi Gorontalo)', 'url' => null]]" />
                    ...
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <div class="avtar avtar-s bg-light-warning">
                                <i class="ph-duotone ph-calendar-check fs-3"></i>
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h5 class="mb-0">Pilih Tahun dan Bulan</h5>
                            <p class="text-muted text-sm mb-0">Pilih tahun dan bulan yang akan ditampilkan</p>
                        </div>
                    </div>
                    <div class="bg-body p-3 mt-3 rounded">
                        <form action="{{ route('admin.ikm.index') }}" method="post">
                            @csrf
                            <div class="row g-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 order-2 order-lg-1">
                            <div class="p-4 text-center text-lg-start">
                                <h4 class="text-white">Provinsi Gorontalo</h4>
                                <p class="text-white">
                                    Berdasarkan hasil penilaian dari {{ $respondentTotal }} responden,
